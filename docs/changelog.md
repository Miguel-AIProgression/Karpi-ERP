...
## 2026-06-13 — Colli-data single-source: omschrijving + label-metadata + gewicht-totaal (mig 389-390)

> **Migratienummers:** repo-nrs **389/390** (vlak vóór merge hernummerd van 388/389 — origin/main claimde intussen 388 via `388_maatwerk_vorm_contour`; mig 387-gewicht stond al op main). In de live DB op 13-06 toegepast onder werknummers 388/389; idempotent, inhoudelijk identiek. Achtergrond: [`docs/superpowers/plans/2026-06-13-sscc-analogen-audit.md`](superpowers/plans/2026-06-13-sscc-analogen-audit.md).
