...
- **Deploy-fan-out:** mig 426 + `hst-send`/`verhoek-send`/`rhenus-send` + frontend horen in één cutover-venster (zie het draaiboek-deel van het plan). De oude artefacten dropt slice 5 ná live-bewijs.
