...
| ~~`rollen_uitwissel_voorraad()`~~ | **GEDROPT in mig 183 (T005)** — vervangen door `voorraadposities()` (mig 179/180). Geen externe callers meer; functie definitief verwijderd. |
