...
| klanteigen_naam_snapshot | TEXT | **Mig 418.** Bevroren klant-eigennaam voor de kwaliteit (`resolve_klanteigen_naam`, bron `klanteigen_namen` mig 199/200). NULL = geen afwijkende naam voor deze klant. De drie labelvarianten tonen "Uw referentie: <naam>" onder de kwaliteitscode alleen als dit veld gevuld is. |
