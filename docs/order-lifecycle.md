...
| Afleveradres ontbreekt | `afl_adres_incompleet_sinds` | BEFORE-trigger `trg_orders_afl_adres_gate` bij leeg afl_naam/adres/postcode/plaats (niet-afhaal, mig 392) | adres aanvullen (trigger wist auto) | [`afleveradres-gate.ts`](../frontend/src/lib/orders/afleveradres-gate.ts) | **Ja** — `start_pickronden` weigert via `_valideer_intake_gates`; herhaalbaar |
| Prijs ontbreekt | `prijs_ontbreekt_sinds` | AFTER-trigger `trg_order_regels_prijs_gate` bij €0/NULL-regel (niet pseudo/VERZEND, korting<100, mig 393) | `markeer_prijs_geaccepteerd` of prijscorrectie | [`prijs-ontbreekt.ts`](../frontend/src/lib/orders/prijs-ontbreekt.ts) | **Ja** — `start_pickronden` weigert via `_valideer_intake_gates`; herhaalbaar |
