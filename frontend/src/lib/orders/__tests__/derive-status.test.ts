...
// (SQL + TS) worden tegen dezelfde 21 cases geborgd (ADR-0006).
...
describe('order-status ladder: TS ≡ golden truthtable', () => {
  it('fixture bevat 21 cases (DO-assertie in mig 346 moet byte-gelijk meelopen)', () => {
    expect(golden.cases).toHaveLength(21)
  })
