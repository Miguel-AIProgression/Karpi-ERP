// Contracttest: TS-spiegel deriveWachtStatus ≡ golden truthtable (mig 346 + 352 + 470 + 540 + 564).
...
// mig 540: 3 Concept-cases toegevoegd; mig 564 (ADR-0040): 'combi'-veld op elke
...
describe('order-status ladder: TS ≡ golden truthtable', () => {
  it('fixture bevat 36 cases (26 origineel + 10 Combi-levering-cases mig 564)', () => {
