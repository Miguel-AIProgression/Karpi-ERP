"""Import prijslijst0219 (House of Dutchz per 1-6-2026) naar Supabase + koppel 14 debiteuren."""
import sys
import re
import io
...
def main():
    print("=== Import prijslijst 0219 (House of Dutchz) ===\n")
    ...
    meta = rows[1]
    naam = str(meta[2]).strip() if meta[2] else "HOUSE OF DUTCHZ"
