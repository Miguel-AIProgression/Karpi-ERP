"""Import prijslijst0254 (Idaho per 1-6-2026) naar Supabase + koppel debiteur 390503."""
import sys
import re
import io
...
FILE = BASE_DIR / "prijslijst0254_a.xlsx"
PRIJSLIJST_NR = "0254"
DEBITEUR_NR = 390503
...
def main():
    print("=== Import prijslijst 0254 (Idaho) ===\n")
    ...
    meta = rows[1]
    naam = str(meta[2]).strip() if meta[2] else "IDAHO PER 1-6-2026"
