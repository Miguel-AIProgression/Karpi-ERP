"""Import prijslijst0217 (Benelux + RM + MV + Bamboe per 01.04.26) naar Supabase + koppel 2 debiteuren."""
import sys
import re
import io
...
FILE = BASE_DIR / "prijslijst0217_a.xlsx"
PRIJSLIJST_NR = "0217"
...
def main():
    print("=== Import prijslijst 0217 (Benelux + RM + MV + Bamboe) ===\n")
    ...
    meta = rows[1]
    naam = str(meta[2]).strip() if meta[2] else "BENELUX + RM + MV + BAMBOE"
