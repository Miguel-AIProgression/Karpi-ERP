"""Import prijslijst0148 (Tapijtcentrum Nederland per 1.9.2022) naar Supabase +
koppel debiteur 771603."""
import sys
import re
import io
...
FILE = BASE_DIR / "Prijslijst TCN 148.xlsx"
PRIJSLIJST_NR = "0148"
DEBITEUR_NR = 771603
...
def main():
    print("=== Import prijslijst 0148 (Tapijtcentrum Nederland) ===\n")
    ...
    meta = rows[1]
    naam = str(meta[2]).strip() if meta[2] else "TAPIJTCENTRUM PER 1.9.2022"
    # Bronbestand gebruikt punten i.p.v. streepjes: "1.9.2022"
