"""Import prijslijst0253 (Prominent per 1-6-2026) naar Supabase + koppel debiteur 623010."""
import sys
import re
import io
...
FILE = BASE_DIR / "Prijs Prominent per 1-6-2026 (basta).xlsx"
PRIJSLIJST_NR = "0253"
DEBITEUR_NR = 623010
...
def main():
    print("=== Import prijslijst 0253 (Prominent) ===\n")
    ...
    meta = rows[1]
    naam = str(meta[2]).strip() if meta[2] else "PROMINENT"
    ...
    if result.data:
        ...
        print(f"  WAARSCHUWING: debiteur {DEBITEUR_NR} niet gevonden of al gekoppeld")
