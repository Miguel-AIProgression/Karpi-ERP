...
// guillotine als FFDH en kiest de beste). De FFDH-variant met dezelfde naam
// is naar werklijst-packing.test.ts verhuisd (test-driver, 0 productie-
// callers — audit 2026-07-02). De bouwstenen hieronder blijven de basis.
