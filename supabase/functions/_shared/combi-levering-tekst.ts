...
export const COMBI_LEVERING_UITLEG: Record<Taal, string> = {
  nl: 'We combineren uw bestelling graag met eventuele andere openstaande orders naar hetzelfde adres. Zo betaalt u geen verzendkosten wanneer het totaal onze vrachtvrije drempel bereikt. Is die drempel rond de genoemde leverdatum nog niet gehaald, dan schuift de levering automatisch iets op. Liever niet wachten? Bestel dan gerust nog wat extra, of neem contact met ons op: dan verzenden we deze order graag alsnog apart, tegen verzendkosten.',
