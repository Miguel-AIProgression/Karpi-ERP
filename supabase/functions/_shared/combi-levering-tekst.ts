...
export const COMBI_LEVERING_UITLEG: Record<Taal, string> = {
  nl: 'We combineren uw bestelling graag met eventuele andere openstaande orders naar hetzelfde adres, zodat u geen verzendkosten betaalt zodra het totaal onze vrachtvrije-drempel bereikt. Is die drempel rond de genoemde leverdatum nog niet gehaald, dan schuift de levering automatisch iets op. Liever niet wachten? Bestel dan gerust nog wat extra, of neem contact met ons op: dan verzenden we deze order graag alsnog apart, tegen verzendkosten.',
  de: 'Wir kombinieren Ihre Bestellung gerne mit weiteren offenen Aufträgen an dieselbe Adresse, damit Sie keine Versandkosten zahlen, sobald der Gesamtbetrag unsere frachtfreie Grenze erreicht. Ist das rund um den genannten Liefertermin noch nicht der Fall, verschiebt sich die Lieferung automatisch etwas. Möchten Sie lieber nicht warten? Bestellen Sie gerne noch etwas dazu, oder kontaktieren Sie uns: Dann versenden wir diesen Auftrag gerne separat, gegen Versandkosten.',
  fr: 'Nous combinons volontiers votre commande avec d\'éventuelles autres commandes en cours vers la même adresse, afin que vous ne payiez pas de frais de port dès que le montant total atteint notre seuil de franco de port. Si ce seuil n\'est pas encore atteint autour de la date de livraison indiquée, la livraison est automatiquement reportée de peu. Vous préférez ne pas attendre ? Commandez alors un peu plus, ou contactez-nous : nous expédierons volontiers cette commande séparément, avec frais de port.',
