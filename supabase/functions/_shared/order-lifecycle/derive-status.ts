...
// in mig 470; mig 558 voegde Combi-levering toe, ADR-0040). null = "niet
...
// contracttest, de mig-558-DO-assertie borgt de SQL-kant.
...
const EINDSTATUS_OF_PICKRONDE: ReadonlySet<string> = new Set([
  ...
  'Maatwerk afgerond',
  // 'Wacht op combi-levering' zit hier BEWUST NIET in (mig 558) — moet
...
export interface WachtStatusInput {
  ...
  /** Mig 558 (ADR-0040): klant wacht op de Combi-levering-drempel — laagste prioriteit. */
 ...
 *  Mig 558: wachtOpCombiLevering heeft de laagste prioriteit — io/tekort/
