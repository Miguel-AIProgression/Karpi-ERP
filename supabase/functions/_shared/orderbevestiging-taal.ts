// Gedeelde taalbepaling voor orderbevestigingen (e-mail én PDF).
// Taal volgt het land van het factuuradres (orders.fact_land, genormaliseerd
// naar ISO2 via de SQL-functie normaliseer_land — single source of truth,
// ook gebruikt in de vervoerder-regelevaluator mig 214).
