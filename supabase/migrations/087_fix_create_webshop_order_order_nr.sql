-- Fix: create_webshop_order sloeg order_nr niet op (geen DEFAULT, geen trigger).
-- Oplossing: roep volgend_nummer('ORD') aan vóór de INSERT, zoals create_order_with_lines doet.
