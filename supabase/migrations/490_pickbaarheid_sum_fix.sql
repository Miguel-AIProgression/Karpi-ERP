-- Mig 490: orderregel_pickbaarheid telt voorraad-claims nu op aantal (SUM)
-- i.p.v. op aanwezigheid van een rij (COUNT).
--
-- Waarom: vóór mig 489 cascadeerde de allocator altijd tot het volledige
...
-- naast een nog open restant. Sinds mig 489 (geen automatische alias/IO-claim
...
-- volledig pickbaar tonen.
--
-- Blijft bewust beperkt tot bron='voorraad' (ongewijzigd) — een IO-claim
-- dekt geen fysiek pickbare voorraad, dat bleef al zo.
