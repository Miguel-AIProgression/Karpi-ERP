...
-- Net als mig 112 is deze placeholder-INSERT no-op gemaakt via
-- `IF FALSE THEN ... END IF;`. Mig 181 verwijdert bestaande PH-rollen.
-- Re-runs maken géén nieuwe PH-rollen meer aan. Achtergrond: zie mig 112.
--
-- ────────────────────────────────────────────────────────────────────────
--
...
-- Deze migratie verbreedde de bron-universe naar
-- maatwerk_m2_prijzen ∪ producten(actief) ∪ kwaliteit_kleur_uitwisselgroepen.
...
BEGIN
  ...
  RAISE NOTICE 'Mig 113 placeholder-INSERT geneutraliseerd in T004 — zie mig 182.';
END $$;
