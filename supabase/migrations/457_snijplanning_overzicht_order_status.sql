-- Migratie 457: order_status additief op snijplanning_overzicht.
--
-- De view kent geen orderstatus-kolom (alleen snijplan-status, ook 'status'
-- genoemd — naamsbotsing). Nodig voor het nieuwe Productie Master Planning-
-- scherm om "openstaande order" (niet Verzonden/Geannuleerd) te filteren
-- zonder een 2e round-trip naar `orders`. Puur additief — bestaande
-- consumenten van de view zijn ongewijzigd (1 extra kolom, geen wijziging
-- aan bestaande kolommen of WHERE-clause).
