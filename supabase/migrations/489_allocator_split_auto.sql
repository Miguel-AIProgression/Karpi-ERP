-- Mig 489: herallocateer_orderregel gesplitst in een korte vorm (alleen eigen
...
-- inkoop) — zie mig 490-491 voor de databron en de bevestig/ontgrendel-RPC's.
--
...
-- expliciet kiest (set_allocatie_keuze, mig 491) of ontgrendelt
-- (ontgrendel_allocatie_keuze, mig 491, roept bewust DEZE korte vorm aan
